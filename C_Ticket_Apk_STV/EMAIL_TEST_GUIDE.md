...
curl -X GET http://192.168.100.29:3000/api/email/config \
  -H "Authorization: Bearer $TOKEN"
```

### 3. Obtener correos de la bandeja
```bash
curl -X GET "http://192.168.100.29:3000/api/email/messages?folder=INBOX&page=1&limit=10" \
  -H "Authorization: Bearer $TOKEN"
```

### 4. Enviar un correo
```bash
curl -X POST http://192.168.100.29:3000/api/email/send \
  -H "Content-Type: application/json" \
  -H "Authorization: Bearer $TOKEN" \
  -d '{
...
```bash
curl -X POST http://192.168.100.29:3000/api/email/config/test \
  -H "Content-Type: application/json" \
  -H "Authorization: Bearer $TOKEN" \
  -d '{
