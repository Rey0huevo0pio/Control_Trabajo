...
export const PERMISOS_POR_ROL: Record<RolUsuario, Permiso[]> = {
  [RolUsuario.VIGILANTE]: [
    Permiso.DASHBOARD_VER, Permiso.CHAT_VER, Permiso.CHAT_ENVIAR,
    Permiso.TICKETS_VER, Permiso.TICKETS_CREAR, Permiso.ARCHIVERO_VER,
  ],
  [RolUsuario.SUPERVISOR]: [
    Permiso.DASHBOARD_VER, Permiso.REPORTES_VER, Permiso.RONDINES_VER,
    Permiso.CHAT_VER, Permiso.CHAT_ENVIAR, Permiso.CHAT_CREAR_GRUPO,
    Permiso.TICKETS_VER, Permiso.TICKETS_CREAR, Permiso.TICKETS_ASIGNAR,
    Permiso.ARCHIVERO_VER, Permiso.ARCHIVERO_CREAR, Permiso.ARCHIVERO_SUBIR,
    Permiso.INSTALACIONES_VER, Permiso.NOTICIAS_VER,
  ],
  [RolUsuario.RH]: [
    Permiso.USUARIOS_VER, Permiso.USUARIOS_CREAR, Permiso.USUARIOS_EDITAR,
    Permiso.DASHBOARD_VER, Permiso.REPORTES_VER, Permiso.REPORTES_EXPORTAR,
    Permiso.CHAT_VER, Permiso.CHAT_ENVIAR, Permiso.CHAT_CREAR_GRUPO, Permiso.CHAT_ADMIN,
    Permiso.TICKETS_VER, Permiso.TICKETS_CREAR, Permiso.TICKETS_EDITAR, Permiso.TICKETS_ASIGNAR,
    Permiso.ARCHIVERO_VER, Permiso.ARCHIVERO_CREAR, Permiso.ARCHIVERO_SUBIR, Permiso.ARCHIVERO_COMPARTIR,
    Permiso.INSTALACIONES_VER, Permiso.NOTICIAS_VER, Permiso.NOTICIAS_CREAR, Permiso.NOTICIAS_EDITAR,
  ],
